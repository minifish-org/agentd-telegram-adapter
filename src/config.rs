...
pub struct Config {
    ...
    pub audio_tool_timeout: Duration,
...
impl Config {
        ...
        F: FnMut(&str) -> Option<String>,
    {
        ...
        Ok(Self {
            ...
            audio_tool_timeout: Duration::from_secs(parse_non_zero_with_default(
                &mut lookup,
                "AUDIO_TOOL_TIMEOUT",
                60u64,
            )?),
...
impl fmt::Debug for Config {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("Config")
            ...
            .field("audio_tool_timeout", &self.audio_tool_timeout)
...
mod tests {
    ...
    fn typed_values_are_parsed_from_environment() {
        ...
        assert_eq!(config.audio_tool_timeout, Duration::from_secs(44));
